...
.\.venv\Scripts\python -m wos_pack_value.cli run --config config/item_values.yaml --raw-dir tests/data
```
...
See `docs/AI_GUIDE.md` for a deeper, AI-focused explanation and extension guidance.
